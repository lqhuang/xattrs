...
T_pred = TypeVar("T_pred", bound=Predicate)
...
T_dpcallable = TypeVar("T_dpcallable", bound=DispatchCallable)
...
P = ParamSpec("P")
R = TypeVar("R")
T_fun: TypeAlias = Callable[P, R]
T_deco: TypeAlias = Callable[[T_fun[P, R]], T_fun[P, R]]
